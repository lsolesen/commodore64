<?php
//require_once("../core/DB_Sql.php");

// burde en dag laves, så den er fuldstændig tilgængelig uden forvirrende
// c64-kommandoer, hvis man ser den fx uden javascript?
// http://www.zimmers.net/cbmpics/cbm/c64/c64ug.txt
// http://bernholm.dk/computermuseum/index.php?view=c64&showMessages=35
// http://sta.c64.org/cbm64baserr.html
...
//$db = new DB_Sql("SELECT * FROM site ORDER BY name");
...
<head>
  ...
  <style type="text/css">
      body { background: #5454FC; text-transform: uppercase; font-weight: normal; font-family: Fixedsys, mono-space; }
      h1, h2, p { font-size: 1em; font-weight: normal; }
      #bodywrap { height: 28em; background: #0000A8; color: #5454FC; margin: 4%; }
  		#bodywrap h1, #bodywrap h2 { text-align: center; margin: 0 0 0.4em 0; padding: 0; }
      #top { padding: 1em 0 0 0; }
  		#top p { margin-top: 1em; }
      #content { background: #0000A8; color: #5454FC; }
  		#content h2 { text-align: left; }
      input { background: #0000A8; border: 0px solid #0000A8; color: #5454FC; font-size: 1em; font-family: Fixedsys, mono-space; text-transform: uppercase;}
      input.submit { color: #0000A8;}
      a { color: #5454FC; text-decoration: none; }
      ul { list-style-type: none; margin: 1em 0 1em 0; padding: 0; }
      li { margin: 0; padding: 0;}
      #foot { margin: 0; padding: 0 0 1em 0; background: #0000A8;  }
  		p { margin: 0; }
  		form { margin: 0; padding: 0; }
  		label { display: none; }
  		pre { letter-spacing: 0; font-family: Fixedsys, mono-space; }
  		span#thecursor { position: relative; left: -0.53em; white-space: pre; font-family: Fixedsys; }
  </style>
</head>
